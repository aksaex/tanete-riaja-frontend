    ...
    <footer className="relative bg-slate-900 text-gray-300 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            <h4 className="text-white font-bold mb-4 text-sm tracking-widest uppercase">Alamat Kantor</h4>
          ...
          >
            <h4 className="text-white font-bold mb-4 text-sm tracking-widest uppercase">Jam Pelayanan</h4>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          >
            <h4 className="text-white font-bold mb-4 text-sm tracking-widest uppercase">Tautan</h4>
            <ul className="space-y-2 text-sm">
              {['Layanan Publik', 'Pengaduan', 'PPID', 'Informasi Geospasial'].map((item) => (
                <li key={item}>
        ...
        {/* Divider */}
        <div className="mt-12 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} Pemerintah Kecamatan Tanete Riaja. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="#" className="hover:text-gray-300 transition">Kebijakan Privasi</Link>
            <Link href="#" className="hover:text-gray-300 transition">Syarat & Ketentuan</Link>
          </div>
        </div>
      </div>
    </footer>
